...
const itemVariants = {
  ...
  visible: (i: number) => ({
    ...
    y: 0,
    scale: 1,
    transition: { duration: 0.5, ease: [0.25, 0.46, 0.45, 0.94] as any, delay: i * 0.06 },
  }),
};
    ...
    <div className="min-h-screen bg-[#0D0416] relative overflow-x-hidden" dir="rtl">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        >
          ...
          <motion.p
            {...(!isMobile
              ? { initial: { opacity: 0, letterSpacing: "0.2em" }, animate: { opacity: 1, letterSpacing: "0.35em" }, transition: { duration: 0.8, delay: 0.1 } }
              : {})}
          ...
          <motion.h1
            {...(!isMobile
              ? { initial: { opacity: 0, y: 15 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.7, delay: 0.15 } }
              : {})}
        ...
        >
          {categories.map((cat) => (
            ...
            >
              {activeCategory === cat.id && !isMobile && (
                <motion.div
                  layoutId="activePill"
          ...
          {filtered.length > 0 ? (
            <motion.div
              ...
              {...(!isMobile
                ...
                : {})}
              className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-6"
            >
